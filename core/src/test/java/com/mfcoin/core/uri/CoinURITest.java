...
//        assertEquals(BTC, uri.getType());
    ...
    public void testAddressRequest() throws Exception {
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://mfcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://mfcoin.com?address=" + MAINNET_GOOD_ADDRESS,
        ...
        assertNull(uri.getAddress());
        assertEquals(BTC, uri.getType());
        assertEquals("https://mfcoin.com/some-path?abc=xyz", uri.getAddressRequestUri().toString());
        assertEquals("https://mfcoin.com/some-path?abc=xyz&address=" + MAINNET_GOOD_ADDRESS,
                uri.getAddressRequestUriResponse(MAINNET_GOOD_ADDRESS).toString());
        ...
        assertEquals("https://mfcoin.com", uri.getAddressRequestUri().toString());
        assertEquals("https://mfcoin.com?address=" + goodAddressStr,
