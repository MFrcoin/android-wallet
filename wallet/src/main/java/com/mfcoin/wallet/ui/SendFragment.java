...
import com.mfcoin.core.coins.FiatType;
...
import com.mfcoin.wallet.AddressBookProvider;
...
import com.mfcoin.wallet.tasks.MarketInfoPollTask;
import com.mfcoin.wallet.ui.widget.AddressView;
import com.mfcoin.wallet.ui.widget.AmountEditView;
import com.mfcoin.wallet.util.ThrottlingWalletChangeListener;
import com.mfcoin.wallet.util.UiUtils;
...
import static com.mfcoin.core.coins.Value.canCompare;
import static com.mfcoin.wallet.ExchangeRatesProvider.getRates;
import static com.mfcoin.wallet.util.UiUtils.setGone;
import static com.mfcoin.wallet.util.UiUtils.setVisible;
    ...
    private final LoaderCallbacks<Cursor> rateLoaderCallbacks = new LoaderManager.LoaderCallbacks<Cursor>() {
        ...
        public void onLoadFinished(final Loader<Cursor> loader, final Cursor data) {
            if (data != null && data.getCount() > 0) {
                HashMap<String, com.mfcoin.core.util.ExchangeRate> rates = new HashMap<>(data.getCount());
                data.moveToFirst();
                do {
