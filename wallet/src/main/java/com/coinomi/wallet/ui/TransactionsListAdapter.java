...
//        final boolean isInternal = WalletUtils.isInternal(tx);
        ...
        if (confidenceType == ConfidenceType.PENDING) {
            ...
            rowDirectionFontIcon.setBackgroundResource(R.mipmap.transaction_row_circle_bg_pending);
            ...
            if (value.isNegative()) {
                rowDirectionFontIcon.setBackgroundResource(R.mipmap.transaction_row_circle_bg_send);
                rowValue.setTextColor(res.getColor(R.color.send_color_fg));
            } else {
                rowDirectionFontIcon.setBackgroundResource(R.mipmap.transaction_row_circle_bg_receive);
